...
export const newEndpointGET = async (Constants, _args, handlers, timeout) => {
  const url = `https://example-data.draftbit.com/activists`;
...
export const useNewEndpointGET = (
  ...
  return useQuery(
    ...
    () => newEndpointGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
