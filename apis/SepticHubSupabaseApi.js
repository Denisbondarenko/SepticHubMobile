...
export const getOrdersGET = async (Constants, _args, handlers, timeout) => {
  const url = `https://hgezxpwspfsiwfdvszsy.supabase.co/rest/v1/orders`;
...
export const useGetOrdersGET = (
  ...
  return useQuery(
    ['orders', args],
    () => getOrdersGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const FetchGetOrdersGET = ({
  children,
  onData = () => {},
  handlers = {},
  refetchInterval,
...
export const useOrderAddressGET = (
  args = {},
  {
    refetchInterval,
    refetchOnWindowFocus,
  ...
  return useQuery(
    ['houseaddress', args],
    () => orderAddressGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
      ...
      retry,
      staleTime,
      onSuccess: () => queryClient.invalidateQueries(['houseaddresses']),
    }
  );
};

export const FetchOrderAddressGET = ({
  children,
  onData = () => {},
  handlers = {},
  refetchInterval,
  ...
  return children({ loading, data, error, refetchOrderAddress: refetch });
};
