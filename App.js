...
import SepicHubTheme from './themes/SepicHubTheme';
import ShipItTheme from './themes/ShipItTheme';
...
const App = () => {
  ...
  const [fontsLoaded] = useFonts({
    ...
    Merriweather_400Regular: Fonts.Merriweather_400Regular,
    Merriweather_300Light: Fonts.Merriweather_300Light,
    Mulish_400Regular: Fonts.Mulish_400Regular,
  });
  ...
  return (
    <>
      ...
      <ThemeProvider
        themes={[ShipItTheme, SepicHubTheme]}
        breakpoints={{}}
        initialThemeName={'ShipIt Theme'}
      >
        <SafeAreaProvider
